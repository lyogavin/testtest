...
train_config_133_102.use_ft_cache = True
#train_config_133_101.lgbm_seed_test_list = [999, 555, 333]
train_config_133_102.lgbm_params = { **lgbm_params_pub_entire_set_test_depth_4_leave_20_scale_1,
                                     **{'early_stopping_round': 300,
                                        'colsample_bytree': 0.6,
                                        'subsample': 0.9,
                                        'max_bin': 150,
...
train_config_133_111.train_smoothcvr_cache_to = id_7_0am
train_config_133_111.val_smoothcvr_cache_from = id_7_0am
train_config_133_111.val_smoothcvr_cache_to = id_9_0am
train_config_133_111.add_features_list = get_cols_com('count') + \
                                        get_cols_com('cumcount') + \
                                        get_cols_com('smoothcvr') + \
                                        get_cols_com('nunique') + \
                                        [
...
train_config_133_120 = copy.deepcopy(train_config_133_106)
train_config_133_120.lgbm_params = { **lgbm_params_pub_entire_set_test_depth_4_leave_20_scale_1,
                                     **{'early_stopping_round': 300,
                                        'colsample_bytree': 0.5,
                                        'subsample': 0.9,
                                        'reg_alpha': 0.2,
...
train_config_133_121 = copy.deepcopy(train_config_133_120)
train_config_133_121.add_features_list = get_cols_com('cumcount') + \
                                        get_cols_com('count') + \
                                        [
                                            {'group': ['ip', 'app', 'device', 'os', 'is_attributed'],
                                             'op': 'nextclick'},
...
train_config_133_122 = copy.deepcopy(train_config_133_120)
train_config_133_122.add_features_list = get_cols_com('nunique') + \
                                        get_cols_com('cumcount') + \
                                        get_cols_com('count') + \
                                        [
                                            {'group': ['ip', 'app', 'device', 'os', 'is_attributed'],
...
train_config_133_123 = copy.deepcopy(train_config_133_120)
train_config_133_123.add_features_list = get_cols_com('nunique') + \
                                        get_cols_com('cumcount') + \
                                        [
                                            {'group': ['ip', 'app', 'device', 'os', 'is_attributed'],
                                             'op': 'nextclick'},
...
train_config_133_124 = copy.deepcopy(train_config_133_120)
train_config_133_124.add_features_list = get_cols_com('var') + \
                                        get_cols_com('count') + \
                                        [
                                            {'group': ['ip', 'app', 'device', 'os', 'is_attributed'],
                                             'op': 'nextclick'},
...
train_config_133_130 = copy.deepcopy(train_config_133_128)
train_config_133_130.add_features_list = get_cols_com('mean') + \
                                        get_cols_com('count') + \
                                        get_cols_com('nextclick') + \
                                        [
                                            {'group': ['ip', 'app', 'device', 'os', 'is_attributed'],
...
train_config_133_131 = copy.deepcopy(train_config_133_128)
train_config_133_131.add_features_list = get_cols_com('mean') + \
                                        get_cols_com('count') + \
                                        [
                                            {'group': ['ip', 'app', 'device', 'os', 'is_attributed'],
                                             'op': 'nextclick'},
...
train_config_133_132 = copy.deepcopy(train_config_133_128)
train_config_133_132.lgbm_params = [{ **lgbm_params_pub_entire_set_test_depth_4_leave_20_scale_1,
                                     **{'early_stopping_round': 300,
                                        'colsample_bytree': 0.5,
                                        'subsample': 0.9,
                                        'reg_alpha': 0.2,
...
train_config_133_147 = copy.deepcopy(train_config_133_120)
train_config_133_147.add_features_list = get_cols_com('var') + \
                                         get_cols_com('count') + \
                                         get_cols_com('nunique') + \
                                         get_cols_com('mean') + \
                                         get_cols_com('cumcount') + \
...
train_config_133_148 = copy.deepcopy(train_config_133_120)
train_config_133_148.add_features_list = get_cols_com('var') + \
                                         get_cols_com('count') + \
                                         get_cols_com('nunique') + \
                                         get_cols_com('nextclick') + \
                                         get_cols_com('mean') + \
...
train_config_133_149 = copy.deepcopy(train_config_133_120)
train_config_133_149.train_smoothcvr_cache_from = 0
train_config_133_149.train_smoothcvr_cache_to = id_8_3pm
train_config_133_149.val_smoothcvr_cache_from = id_8_4am
train_config_133_149.val_smoothcvr_cache_to = id_8_3pm
train_config_133_149.use_scvr_cache_file = True
train_config_133_149.add_features_list = get_cols_com('var') + \
                                         get_cols_com('count') + \
                                         get_cols_com('nunique') + \
                                         get_cols_com('smoothcvr') + \
                                         get_cols_com('nextclick') + \
